...
export default function HeroSection() {
    ...
    return (
        <div className="min-h-[45rem] mt-20">
            {mounted && <main className="w-full p-5 flex min-h-[45rem] items-center justify-center mx-auto h-full overflow-x-hidden relative">
                ...
                <section className="flex max-w-5xl justify-center mx-auto md:min-h-screen lg:-translate-y-20 max-md:justify-start z-20 flex-col lg:flex-row md:h-full items-center gap-4" aria-label="Introduction">
