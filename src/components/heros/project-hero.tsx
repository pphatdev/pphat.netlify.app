...
export const ProjectHero = () => {
    return (
        <BlurFade delay={0.15} inView className="min-h-36 sm:min-h-80 flex flex-col border-b overflow-clip relative items-start justify-center">
            <Meteors />
            ...
            <div className="w-full p-4 sm:px-10 flex flex-col max-w-5xl mx-auto ">
                ...
                <BlurFade delay={0.5} inView className="flex max-sm:order-first flex-col items-start justify-start">
                    <Link href="/" className="hover:bg-foreground/5 font-default transition-all duration-300 max-sm:mt-0 mt-7 items-center hover:ring w-fit ring-foreground/10 justify-start flex rounded-full hover:px-4 p-1.5">
