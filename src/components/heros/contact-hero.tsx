        ...
        <div className="min-h-36 sm:min-h-60 flex bg-linear-to-b from-primary/10 pt-14 sm:pt-24 to-background flex-col overflow-clip relative items-start justify-center">
            ...
            <div className="w-full p-4 sm:px-5 space-y-5 flex flex-col max-w-5xl mx-auto ">
                <BlurFade delay={0.6} inView className="flex flex-col items-center justify-center">
                    <h1 className="text-3xl font-bold sm:text-5xl xl:text-6xl/none"> Get in <span className="text-left bg-background  bg-clip-text bg-no-repeat text-transparent bg-linear-to-r  from-sky-500 via-teal-500 to-green-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">Touch</span> </h1>
                </BlurFade>
