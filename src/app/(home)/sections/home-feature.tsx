...
const Feature = ({
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 relative z-10 px-10 group-hover/feature:text-primary text-primary/80">
                {icon}
            </div>
            ...
            <p className="text-sm text-foreground/80 max-w-xs relative z-10 px-10">
                {description}
            </p>
        </div>
    );
