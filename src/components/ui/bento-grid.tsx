...
function BentoGrid({ items = itemsSample }: BentoGridProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-5 pt-6">
                ...
                <BlurFade
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm line-clamp-2 text-gray-600 dark:text-gray-300 leading-snug font-[425]">
                                {item.description}
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center space-x-2 text-xs text-foreground/70">
                                {item.tags?.map((tag, i) => (
                                    <span key={i} className="px-2.5 py-1 rounded-full bg-foreground/10 backdrop-blur-sm transition-all duration-200 hover:bg-foreground/20">
                                        {tag}
                                    </span>
                                ))}
                            </div>
