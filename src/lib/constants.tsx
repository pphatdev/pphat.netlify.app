...
export const NEXT_PUBLIC_API = RAW_NEXT_PUBLIC_API.replace(/\/v1\/api\/(posts|articles|projects)\/?$/, "");
...
export const FAQS: { question: string; answer: React.ReactNode }[] = [
    ...
    },
    {
        ...
        answer: (
            <p>
                You can contact {PERSON_NAME} via email at {CONTACT_EMAIL},
                connect with him on LinkedIn at <Link href={LINKEDIN_URL} target="_blank" className="text-primary font-bold">LinkedIn</Link>,
                or explore his open-source work on GitHub at <Link href={GITHUB_URL} target="_blank" className="text-primary font-bold">GitHub</Link>.
                You can also reach out directly through the <Link href={`${NEXT_PUBLIC_APP_URL}/contact`} target="_blank" className="text-primary font-bold">Contact</Link> page.
            </p>
        ),
    },
];