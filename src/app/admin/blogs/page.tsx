            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {([
                    ...
                    >
                        ...
                        <p
                            className={`mt-1.5 text-2xl font-semibold tracking-tight ${stat.color}`}
                        >
                            {stat.value}
                        </p>
                    </div>
                    ...
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <div className="relative size-16 shrink-0 overflow-hidden rounded-xl border border-border/60 bg-muted">
                                ...
                                {/* Status dot */}
                                <span
                                    className={`absolute right-1 top-1 size-2.5 rounded-full border border-background ${post.published ? 'bg-emerald-500' : 'bg-amber-400'
                                        }`}
                                />
                            </div>
