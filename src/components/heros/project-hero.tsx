...
export const ProjectHero = () => {
    return (
        <BlurFade delay={0.15} inView className="min-h-36 sm:min-h-80 flex bg-gradient-to-b from-primary/10 to-background flex-col border-b overflow-clip relative items-start justify-center">
            {/* <Meteors /> */}
            ...
            <div className="w-full p-4 sm:px-10 flex flex-col max-w-5xl mx-auto ">
                <BlurFade delay={0.6} inView className="flex flex-col items-start justify-start">
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none"> Pro<span className="text-left bg-background  bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r from-sky-500 via-teal-500 to-green-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">jects</span> </h1>
                </BlurFade>
